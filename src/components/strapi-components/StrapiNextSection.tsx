...
const StrapiNextSection: FC<StrapinextSectionProps> = ({ data }) => {
  ...
  return (
    <CustomSection>
      <div className="w-full md:w-11/12 xl:w-10/12 2xl:w-8/12 space-y-7 mx-auto">
        <HighlightedText
          text={title}
          className="uppercase text-lg md:text-2xl tracking-widest text-center"
        />
        <HighlightedText
          text={description}
          className="text-2xl mt-0 md:text-4xl font-bold text-center"
        />
      </div>
      <div
        className={
...
export default StrapiNextSection;